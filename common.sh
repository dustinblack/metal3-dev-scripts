...
export IRONIC_IMAGE=${IRONIC_IMAGE:-"quay.io/dustinblack/metalkube-ironic:lockdown2"}
export IRONIC_INSPECTOR_IMAGE=${IRONIC_INSPECTOR_IMAGE:-"quay.io/dustinblack/metalkube-ironic-inspector:lockdown2"}
